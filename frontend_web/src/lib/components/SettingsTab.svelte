<script lang="ts">
	import { theme, audioPresetTitles, subtitlePresetTitles } from '$lib/stores/settings';
...
<div class="tab-container">
	...
	<div class="form-group">
		<label>Audio Preset Titles</label>
		<p class="description">Quick-access titles for audio tracks</p>
		<!-- TODO: Add PresetTitleEditor component -->
		<div class="preset-placeholder">Preset editor - Coming soon</div>
	</div>

	<div class="form-group">
		<label>Subtitle Preset Titles</label>

...
- Updated dependencies pyside6, qtawesome, fastapi, and uvicorn

### Fixed

- MacOS unable to select mp4box executable

## [2.1.2] - 2026-03-27

### Changed

- Updated dependencies for web UI

### Fixed

- Fixed edge case bug for external srt subtitles
